...
class _ThirdRouteState extends State<ThirdRoute> {
  ...
  //final Stream<QuerySnapshot> user = FirebaseFirestore.instance.collection('gobi').doc("userdata").collection("userdata").where("category",isEqualTo: "Expenses").snapshots();
  @override
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
        stream: FirebaseFirestore.instance.collection(user1!).doc("userdata").collection("userdata").where("category",isEqualTo: "Expenses").snapshots(),
